...
export const createUsersSchema = z.object({
  ...
  passwordHash: z
    .string()
    .min(1, { message: 'PasswordHash is required and cannot be empty' }),
});
...
export const processUsersQueryParams = (
  ...
  if (!parseResult.success) {
    ...
    console.error('users query parameter processing error:', parseResult.error);
